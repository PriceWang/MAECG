...
def get_args_parser():
    ...
    # Dataset parameters
    parser.add_argument('--data_path', default='/home/guoxin/storage/ssd/public/unsupervisedecg/cinc2021_unlabelled/', type=str,
                        help='dataset path')

    parser.add_argument('--output_dir', default='./pretrains/output',
                        help='path where to save, empty for no saving')
    parser.add_argument('--log_dir', default='./pretrains/log',
