...
LastEditTime: 2024-12-17 15:27:42
FilePath: /workspace_3090/MAECG/vit_mae.py
Description: Models
...
__all__ = [
    ...
    "mae_vit_xxatto_patch32",
    "mae_vit_xatto_patch32",
...
class CNN1D(nn.Module):
    def __init__(
        ...
        **kwargs,
        ...
        self.init_head(mlp_sizes)
        self.apply(self._init_weights)

    def init_head(self, mlp_sizes):
        self.head = nn.Sequential(nn.Flatten(), MLP(256, mlp_sizes))
...
def mae_vit_xxatto_patch32_dec128d8b(**kwargs):
...
def mae_vit_xatto_patch32_dec128d8b(**kwargs):
    model = MaskedAutoencoderViT1D(
        patch_size=32,
        embed_dim=96,
        depth=6,
...
def mae_vit_large_patch32_dec512d8b(**kwargs):
    model = MaskedAutoencoderViT1D(
        patch_size=32,
        embed_dim=1024,
        depth=24,
...
def mae_vit_huge_patch32_dec512d8b(**kwargs):
    model = MaskedAutoencoderViT1D(
        patch_size=32,
        embed_dim=1280,
        depth=32,
...
cnn1d = cnn
mae_vit_xxatto_patch32 = mae_vit_xxatto_patch32_dec128d8b  # decoder: 256 dim, 8 blocks
mae_vit_xatto_patch32 = mae_vit_xatto_patch32_dec128d8b  # decoder: 256 dim, 8 blocks
...
mae_vit_huge_patch32 = mae_vit_huge_patch32_dec512d8b  # decoder: 512 dim, 8 blocks

vit_xxatto_p32 = vit_xxatto_patch32
vit_xatto_p32 = vit_xatto_patch32
